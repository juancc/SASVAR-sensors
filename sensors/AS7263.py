"""
Based on: https://github.com/UnfinishedStuff/AS7262_Pi/blob/master/AS7262_Pi.py
Original file: A set of Python functions to control the Sparkfun AS7262 Visible spectrometer on a Raspberry Pi.
